...
<html>
    ...
    <body>
        ...
        <section>
            <div class="imagem">
                <img src="../images/stratocaster.jpg" class="imagem-principal"/>
            
                    <div class="artigostrato">
                        <article>
                            <h1>Fender Stratocaster</h1>
                            <hr style="color:black">
                            <p>A Fender Stratocaster é um modelo de guitarra elétrica desenhada por Leo Fender, George Fullerton e Freddie Tavares em 1954, e fabricada continuamente até os dias de hoje.<br/>

Ficou famosa por ter sido a guitarra de, Jimi Hendrix, David Gilmour, Eric Clapton, Yngwie Malmsteen, Eric Johnson, Stevie Ray Vaughan, Mark Knopfler, Dave Murray, Buddy Guy, Rory Gallagher, Ritchie Blackmore, Jeff Beck, Janick Gers, James Root, Tony Iommi, John Mayer e inúmeros outros grandes guitarristas também a usaram.</p>
...
O design da Stratocaster tem sido copiado e modificado constantemente. É possível ver muitos modelos parecidos ou até mesmo com o mesmo design de outros fabricantes de guitarra.<br/>
