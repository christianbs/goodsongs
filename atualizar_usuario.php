...
<section class="col-sm-4">
    <form role="form" enctype='multipart/form-data' action="php/controles/atualiza_cadastro_usuario.php" method="post"
          onsubmit="return validarFormularioDeAlteracaoDeUsuario();">
        ...
        <div class="form-group">
            ...
            <label for="sexo"> <input type="radio" name="sexo" id="M" value="M" <?php echo $checkedM ?>>
                Masculino</label><br>
            <label for="sexo"> <input type="radio" name="sexo" id="F" value="F" <?php echo $checkedF ?>>
                Feminino</label><br>
        </div>

        <div class="form-group">
            <label for="dataNascimento">Data nascimento:</label>
            <input type="text" class="form-control" value="<?php echo $nascimento ?>" id="dataNascimento"
                   name="dataNascimento"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" value="<?php echo $idDadosPessoais ?>" id="idDadosPessoais"
                       name="idDadosPessoais">
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" value="<?php echo $idEndereco ?>" id="idEndereco"
                       name="idEndereco">
            </div>
