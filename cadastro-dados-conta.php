<?php
   $mensagem = "";  
    ...
    }if(strcmp(htmlspecialchars ($_POST["email"]),htmlspecialchars ($_POST["confirmaEmail"])) != 0 ){
       
         $mensagem .= "ERRO OS EMAILS ESTÃO DIFERENTES INSIRA NOVAMENTE  <BR> ";
        
              
    }if(strlen(htmlspecialchars ($_POST["cpf"])) < 11 ){
       
         $mensagem .= "ERRO O CPF DEVE CONTER 11 CARACTERES  </br> ";
